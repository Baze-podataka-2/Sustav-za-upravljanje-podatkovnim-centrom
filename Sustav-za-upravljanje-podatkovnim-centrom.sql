...
CREATE TABLE konfiguracija_uredjaja ( -- Mozda trigger koji ce obustaviti izmjenu opreme u konfiguracijsom setu ako ona izade iz rangea, tj. biti ce poruka nema opreme bolje od te, neka tehnicar ili netko napravi odrzavanje npr
	id SERIAL PRIMARY KEY,
